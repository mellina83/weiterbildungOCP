package ml.novytska.HA1406.unchecked;

import ml.novytska.HA1406.checked.NegativeSaldoExeption;
...
public class Konto {
	...
	public void geldAbheben(double saldo) throws NegativeSaldoRuntimeException {
		if (this.saldo >= saldo) {
			...
			throw new NegativeSaldoRuntimeException("Aktuellen Saldo ist nicht ausreichend " + this.saldo);
		}
