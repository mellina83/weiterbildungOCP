 ...
 *      Bestellungen erhält und damit mithilfe einer Pipeline die Liste mit den
 *      bestellten Produkten erstellt:
 * 
 *      Die Preise für die zu erzeugende Produkte darf die Methode
 *      `buildWarenkorb` selbst (frei) bestimmen.
 * 
 * @Optional Die Preise für die zu erzeugende Produkte sucht die Methode
...
public class Aufgabe06_Collect_Map_Warenkorb {
